...
data_downloadables = {
    ...
    #         "https://dl.dropboxusercontent.com/s/n0mza00cnxigjb4/structured_seed951.zip"
    #     ],
    #     "post_download": [
    ...
    #         do_task("unzip structured_seed951.zip"),
    #         do_task("rm structured_seed951.zip")
    #     ]
    # }#,
    "hmdb": {
        "link" : [
...
def setup_data():
    # assume data path
    data_dir = '/files/yxue/research/allstate/data'
