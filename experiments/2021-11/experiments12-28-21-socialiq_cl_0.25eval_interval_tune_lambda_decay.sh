...
run() {
    ...
    for i in {1..20}
    do
        opath=/files/yxue/research/allstate/out/socialiq_cl/lr${lr}_warmup5000_ep15_exp3-10-${a}-${b}-${g}_seed1029_task3-bs20_0.25eval_interval
...
run 1 0.7 0.7 0.5 0.005 1 &
run 2 1 1 1 0.005 30 &
run 3 1 1 1 0.004 60 &
run 0 0.7 0.7 0.5 0.004 90;