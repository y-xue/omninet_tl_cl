...
run() {
    ...
    for i in {1..20}
    do
        opath=/files/yxue/research/allstate/out/socialiq_cl/lr${lr}_warmup5000_ep15_exp3-${l}-${a}-${b}-${g}_seed1029_task3-bs32_0.25eval_interval_es${es1}-${es2}-${es3}-${es4}
...
run 1 1 1 1 0.002 20 20 20 10 0 1 &
run 2 1 1 1 0.003 20 20 20 10 0 30 &
run 3 1 1 1 0.004 20 20 20 10 0 60;
