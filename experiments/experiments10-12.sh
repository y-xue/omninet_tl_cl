...
--model_save_path /out/mm/random_seq/${seq}_sample_weights${sw}_${bs}bs_${n_iter}it_$((all_seed[$i]))_dropout_${dropout1}_${dropout2} \
--move_out_path ${move_out}/mm/random_seq/${seq}_sample_weights${sw}_${bs}bs_${n_iter}it_$((all_seed[$i]))_dropout_${dropout1}_${dropout2} \
...
--all_seed $((all_seed[$i])) --rewarding --pick_seq random > /mm_random_seq_seq_${seq}_sample_weights${sw}_${bs}bs_${n_iter}it_$((all_seed[$i]))_dropout_${dropout1}_${dropout2}.log;
rm -r /out/mm/random_seq/${seq}_sample_weights${sw}_${bs}bs_${n_iter}it_$((all_seed[$i]))_dropout_${dropout1}_${dropout2};
sleep 10;
