...
# --save_interval 6470 --eval_interval 6470 --conf_type vqa_struct \
# --model_save_path /files/yxue/research/allstate/out/omninet/struct_domain/vqa_struct_norm_bs64_struct_periph_3_encoder_only_dp0.1_0.5_0.5_init_lr0.01 \
# --move_out_path /files/yxue/research/allstate/out/omninet/struct_domain/vqa_struct_norm_bs64_struct_periph_3_encoder_only_dp0.1_0.5_0.5_init_lr0.01 \
# --structured_folder synthetic_structured_clustering_std3 --inject_at_encoder \
