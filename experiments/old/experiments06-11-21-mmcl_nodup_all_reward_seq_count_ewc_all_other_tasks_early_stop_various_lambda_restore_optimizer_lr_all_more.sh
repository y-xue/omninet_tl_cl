...
run1() {
	...
	do
		run 0 0 0 0 0 100 ${lr} 2 ${ds} 2000 2000 2000 2000 2000;
		sleep 5;
	done
}
...
run2() {
	...
	for lr in 0.005 0.008
	do
		run 1 0 0 0 0 100 ${lr} 2 ${ds} 2000 2000 2000 2000 2000;
		sleep 5;
	done
}
...
run3() {
	...
	for lr in 0.005 0.008
	do
		run 3 0 0 0 0 100 ${lr} 2 ${ds} 2000 2000 2000 2000 2000;
		sleep 5;
	done
}
