...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False, small=False):
...
def resnet152(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        # try:
        #     model.load_state_dict(model_zoo.load_url(model_urls['resnet152'], '/files/yxue/research/resnet152'))
        # except:
        #     model.load_state_dict(model_zoo.load_url(model_urls['resnet152']))#, '/mnt-gluster/data/yxue/research/omninet_data/resnet152'))
    return model
